# Hosting an Online Resume with Markdown, Hugo, and GitHub Pages
...
2. Open the folder on your local computer where you want to store your repository.
3. Open your command line application in this folder.
...
4. Run the command `git clone [your repository link]`.
...
1. Run the command `cd [your repository name]` in your command line application.
2. Run the command `hugo new site [your website name]`.
...
3. Run the command `git submodule add https://github.com/theNewDynamic/gohugo-theme-ananke themes/ananke`.
...
4. Open the `config.toml` file in your site folder in your text editor.
5. Add a line to `config.toml` that says `theme = 'ananke'`.
    - If you've chosen another theme than Ananke, replace `'ananke'` with the name of your theme.
6. Change the `baseURL` field to `https://github.io/[your GitHub username]/[your repository name]`.
>Note: This step is crucial to make sure GitHub Pages will properly display your website in later steps!
7. Change the `title` field to whatever title you'd like your website to have.
8. Save your changes to `config.toml`.
...
1. Run the command `hugo new posts/my-resume.md`.
...
2. Navigate to the **posts** folder in a file explorer.
3. Open `my-resume`.md in your text editor.
4. Change the `title` field to the title you'd like your resume post to have!
5. Copy the contents of your Markdown resume into `my-resume.md` directly underneath the header.
...
1. Run the command `hugo server -D`.
...
2. Enter the URL outputted by `hugo server -D` in a web browser. You should see your site, complete with your resume!
...
1. Open `my-resume.md` in your text editor.
2. Change the `draft` field to `false`.
3. Save your changes to `my-resume.md`.
4. Open the folder called `.github` inside your repository in your file explorer.
5. Create a folder called `workflows`.
6. Create a file in the `workflows` folder called `gh-pages.yml`.
7. Copy the contents of [Shohei Ueda's GitHub Pages workflow for Hugo](https://github.com/peaceiris/actions-hugo#%EF%B8%8F-create-your-workflow) into `gh-pages.yml`.
...
8. Open your command line application.
9. Run the command `hugo`.
...
3. Enter **gh-pages** in the textfield labelled **"Find or create a branch…"**.
...
4. Go to **Settings** > **Pages** > **Build and deployment** in your repository on GitHub.
5. Set **Source** to **Deploy from a branch**.
6. Set the dropdown menus underneath to **gh-pages** and **/ (root)**.
...
8. Open your command line application.
9. Move to your repository folder, the folder that contains your Hugo site's folder.
...
10. Run the command `git add -All`.
...
11. Run the command `git commit -all -message "Created a new Hugo site"`.
...
13. Enter the URL you used in `config.toml` into a web browser!
...
- Victoria Drake ([victoriadrake](https://github.com/victoriadrake) on GitHub), creator of the Neofeed theme
